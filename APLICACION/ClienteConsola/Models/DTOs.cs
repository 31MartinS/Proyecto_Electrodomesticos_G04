...
namespace ClienteConsola.Models
{
    ...
    public class ClienteFacturaDto
    {
        ...
        public string Nombres => Nombre;
        public string Apellidos => Apellido;
    }
    ...
    public class DetalleFacturaListDto
    {
        ...
        public ProductoDetalleDto Producto { get; set; } = new ProductoDetalleDto();
        
        // Propiedades calculadas para compatibilidad
        public string NombreProducto => Producto?.Nombre ?? "";
        public decimal Subtotal => TotalLinea;
    }
